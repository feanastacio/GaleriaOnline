...
namespace GaleriaOnline.WebApi.Controllers
{
    ...
    public class ImagemController : ControllerBase
    {
        ...
        private readonly IWebHostEnvironment _env; //Serve para se adaptar com o ambiente de hospedagem
        ...
        public async Task<IActionResult> AtualizarImagem(int id, PutImagemDto imagemAtualizada)
        {
            ...
            {
                return BadRequest("Pelo menos um dos campos tem que ser preencido."); ;
            }
